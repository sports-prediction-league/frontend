      ...
      <div className="flex flex-col md:flex-row justify-between items-center max-w-full w-full md:px-[90px] px-[16px]">
        <div className="flex flex-col gap-[10px] md:w-[516px] w-full">
          <div className="flex items-center justify-center md:justify-start gap-[10px] w-full">
            <img src={SPL_LOGO_LARGE} alt="SPL LOGO" className="md:h-[80px] md:w-[80px] h-[24px] w-[24px]" />
        ...
        <div className="flex justify-end items-center gap-[8px] md:mt-auto mt-3 md:mb-0 mb-3">
          <img src={X} alt="X" className="cursor-pointer hover:scale-110 transition-all duration-300 md:h-[37px] md:w-[37px] h-[16px] w-[16px]" />
          <img src={TELEGRAM} alt="TELEGRAM" className="cursor-pointer hover:scale-110 transition-all duration-300 md:h-[45px] md:w-[45px] h-[20px] w-[20px]" />
        </div>
      </div>
